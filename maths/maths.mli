(** Mathematical functionality utility library.
    ...
    We acknowledge that similar functionality can be found in the Ocaml
    Float module. However, our implementations differ from the provided
    module in that it takes into consideration extra algorithm-specific
    parameters such as range and spread *)
